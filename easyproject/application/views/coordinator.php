                  ...
                  <div class="col-md-6 col-xs-12">
                        ...
                        <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url('asset/img/document.png'); ?>">
                            <div class="overlay-box">
                                <div class="user-content">
                                    <a href="<?php echo base_url('index.php/Welcome/project_groups'); ?>"><img src="<?php echo base_url('asset/img/document.png'); ?>" class="thumb-lg img-circle" alt="img"></a>
                                </div>
                            </div>
                        </div>
                        <div class="user-btm-box">
                            <div class="col-md-12 col-sm-12 text-center">
                                <a href="<?php echo base_url('index.php/Welcome/project_groups'); ?>"><h4>Project Groups</h4></a>
                            </div>
                        </div>
                    </div>
                </div>
                    <div class="col-md-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="user-btm-box">
                                <div class="col-md-12 col-sm-12 text-center">
                                    <a href="<?php echo base_url('index.php/Welcome/students'); ?>"><h4>Profile</h4></a>
                                </div>
                            </div>
                        </div>
                    </div>
