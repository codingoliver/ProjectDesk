...
<body>
 ...
 waves-effect waves-light"><i class="ti-arrow-circle-left ti-menu"></i>
        ...
        <div class="container-fluid">
            ...
            <div class="row ">
                    ...
                    <div class="white-box ">
                        ...
                        <div class="user-btm-box">
                            <div class="col-md-12 col-sm-4 text-center">
                                ...
                                <h3><?php echo $data[0]->department; ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-8 col-xs-12">
                    <div class="white-box " >
                         <form enctype="multipart/form-data" class="form-horizontal form-material" method="post" action="http://localhost/easyproject/index.php/Welcome/update_user_detail/coordinator">
                            ...
                            <div class="form-group ">
                                <div class="col-sm-12">
                                    <button data-type='coordinator' class="btn btn-success">Update Profile</button>
                                </div>
                            </div>
    ...
    <script src="<?php echo base_url('asset/js/profile.js'); ?>"></script>
</body>
