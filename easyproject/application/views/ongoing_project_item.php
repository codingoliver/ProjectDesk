            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="white-box" style="background-color: white;">
                        <h3>PROJECT TITLE: <?php echo $data2[0]->title ?> </h3>
                        <h5><b><i>Supervised by:</i></b> <a> <?php echo $data2[0]->supervisor_fullname ?> </a></h5>

                        <div class="post-tags">
                            <h5><b><i>Department:</i></b><a> <?php echo $data2[0]->department?> </a></h5>
                        </div>

                        <p> <?php echo $data2[0]->detail ?> </p>


                        <h5><b><i>Project Documents</i></b></h5>
                        <?php

                            foreach ($data3 as $value) {
                                echo "
                                     <a style='color:red' href='".base_url('index.php/Welcome/download_project_doc/'.$value->o_p_d_id)."'>
                                     
                                      Click to download $value->title <span style='color: grey'>File size : $value->size KB</span></a><br/>
                                    ";
                            }
                        ?>
                    </div>
