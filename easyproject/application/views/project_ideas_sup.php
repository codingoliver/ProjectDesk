        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li class="active">List of your uploaded project ideas</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                         ...
                         <form class="form-horizontal form-material" method="post" action="http://localhost/easyproject/index.php/Welcome/insert_project_idea_sup">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea type ="text" id="detail" name="detail" hint="Enter project detail" class="form-control form-control-line" required> </textarea> 
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                         ...
                         <form id="form" class="form-horizontal form-material" method="post" action="http://localhost/easyproject/index.php/Welcome/update_project_idea_sup/">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-12">Select departmente</label>
                                <div class="col-sm-12">
        ...
        <!-- ABSTRACT MODAL -->
            <div class="modal fade" id="abstractModal" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                         ...
                         <form id="form" class="form-horizontal form-material" action="<?php echo base_url('index.php/Welcome/project_ideas_sup') ?>">
                        <div class="modal-body">
                                          ...
                                          foreach($data as $value)
                                          {
                                            echo '<tr>';
                                                ...
                                                echo "<td>
                                                    ...
                                                    <button class='btn btn-danger' data-type='S".$value->p_i_id."'><i class='ti-trash fa-fw' ></i> Remove</button>
                                                    </td>";
