        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-12">
                        <h4 class="page-title">Welcome to the student portal, <?php echo $data[0]->fullname ?></h4>
                        <ol class="breadcrumb">
                     ...
                     <div class="white-box">
                        <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url('asset/img/idea.png'); ?>">
                            <div class="overlay-box">
                                <div class="user-content">
                                    <a href="<?php echo base_url('index.php/Welcome/project_ideas'); ?>"><img src="<?php echo base_url('asset/img/idea.png'); ?>" class="thumb-lg img-circle" alt="img"></a>
                        ...
                        <div class="user-btm-box">
                            <div class="col-md-12 col-sm-12 text-center">
                                <a href="<?php echo base_url('index.php/Welcome/project_ideas'); ?>"><h4>Project ideas</h4></a>
                            </div>
                        </div>
                    </div>
                </div>
                  <div class="col-md-4 col-xs-12">
                    <div class="white-box">
                        <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url('asset/img/document.png'); ?>">
                            <div class="overlay-box">
                                <div class="user-content">
                                    <a href="<?php echo base_url('index.php/Welcome/proj_doc_stud') ?>"><img src="<?php echo base_url('asset/img/document.png'); ?>" class="thumb-lg img-circle" alt="img"></a>
                                </div>
                            </div>
                        </div>
                        <div class="user-btm-box">
                            <div class="col-md-12 col-sm-12 text-center">
                                <a href="<?php echo base_url('index.php/Welcome/proj_doc_stud') ?>"><h4>Project documents</h4></a>
                            </div>
                        </div>
                    </div>
                </div>
                  <div class="col-md-4 col-xs-12">
                      <div class="white-box">
                        <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url('asset/img/group-chat.png'); ?>">
                            <div class="overlay-box">
                                <div class="user-content">
                                    <a href="<?php echo base_url('index.php/Welcome/chatroom_student') ?>"><img src="<?php echo base_url('asset/img/group-chat.png'); ?> " class="thumb-lg img-circle" alt="img"></a>
                                </div>
                            </div>
                        </div>
                        <div class="user-btm-box">
                            <div class="col-md-12 col-sm-12 text-center">
                                <a href="<?php echo base_url('index.php/Welcome/chatroom_student') ?>"><h4>Chat Room</h4></a>
                            </div>
                        </div>
                    </div>
                </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url('asset/img/document.png'); ?>">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="<?php echo base_url('index.php/Welcome/ongoing_project/all') ?>"><img src="<?php echo base_url('asset/img/document.png'); ?> " class="thumb-lg img-circle" alt="img"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="user-btm-box">
                                <div class="col-md-12 col-sm-12 text-center">
                                    <a href="<?php echo base_url('index.php/Welcome/ongoing_project/all') ?>"><h4>Ongoing Projects</h4></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url('asset/img/document.png'); ?>">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="<?php echo base_url('index.php/Welcome/finished_project/all') ?>"><img src="<?php echo base_url('asset/img/document.png'); ?> " class="thumb-lg img-circle" alt="img"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="user-btm-box">
                                <div class="col-md-12 col-sm-12 text-center">
                                    <a href="<?php echo base_url('index.php/Welcome/finished_project/all') ?>"><h4>Finished Projects</h4></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url('asset/img/user.png'); ?>">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="<?php echo base_url('index.php/Welcome/student_profile') ?>"><img src="<?php echo base_url('asset/img/user.png'); ?> " class="thumb-lg img-circle" alt="img"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="user-btm-box">
                                <div class="col-md-12 col-sm-12 text-center">
                                    <a href="<?php echo base_url('index.php/Welcome/student_profile') ?>"><h4>Profile</h4></a>
                                </div>
                            </div>
                        </div>
                    </div>
