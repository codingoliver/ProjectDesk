        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li class="active">Manage students here</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box js-sweetalert9">
                            <button data-name="modal" class="btn btn-info waves-effect waves-light"  data-toggle="modal" data-target="#defaultModal"><i class='ti-plus fa-fw'></i> Add new student</button>
                            <br/><br/>
...
function validateUser()
{
    ...
    $.get('http://localhost/easyproject/index.php/Welcome/check_student/'+ staff_id,
        {
            email : email
        },
        function(data, status) {
            ...
            if(data === 'Staff doesnot exist') {
                ...
                $.post('http://localhost/easyproject/index.php/Welcome/insert_student',
                    {
                        fullname : fullname,
                        staff_id : staff_id,
                        email : email,
                    ...
                    function(data, status) {
                            ...
                            if(data === 'success') {
                                ...
                                window.location = 'http://localhost/easyproject/index.php/Welcome/students';
                            }
                    }
                );
            } else {
                divError.html("<p style='color: red'>Student already exists</p>");
            }
        }
    );
